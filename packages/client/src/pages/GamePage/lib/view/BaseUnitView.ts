...
export abstract class BaseUnitView {
  ...
  render(unit: Unit) {
    ...
    const fullTextWidth = this._context.measureText(name).width
    const textHeight = 16
    ...
    this._context.fillRect(boxX, boxY, boxWidth, boxHeight)

    this._context.fillStyle = 'white'
    this._context.fillText(text, boxX + boxWidth / 2, boxY + boxHeight / 2)
  }
