...
export abstract class BaseProjectileView {
  ...
  constructor(context: CanvasRenderingContext2D, from: Position, to: Position) {
  ...
  render(): void {
    ...
    this._context.rotate(this._angle + Math.PI / 2)
    this._context.drawImage(this._image, -width / 2, -height / 2, width, height)
